...
eMtErr test_pack_0002_s2m()
{
	   ...
	   sCmPacket *pscmPacket = (sCmPacket*)g_ucPackMem;
	    ...
	    pscmPacket->ucCmdNum = 1;
	    pscmPacket->sCmdData[0].eCmd  = CMD_AFN_0_F2_ALL_DENY;
	    pscmPacket->sCmdData[0].bApp  = TRUE;
	    pscmPacket->sCmdData[0].usPN  = 0;
...
eMtErr test_pack_0002_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_0_F2_ALL_DENY;
    pscmPacket->sData[0].bApp  = TRUE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn0f3_s2m()
{
   ...
   sCmPacket *pscmPacket = (sCmPacket*)g_ucPackMem;
    ...
    pscmPacket->ucCmdNum = 1;
    pscmPacket->sCmdData[0].eCmd  = CMD_AFN_0_F3_ONE_BY_ONE;
    pscmPacket->sCmdData[0].bApp  = TRUE;
    pscmPacket->sCmdData[0].usPN  = 0;
...
eMtErr test_pack_afn0f3_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
	...
	pscmPacket->usDataNum = 1;
	pscmPacket->sData[0].eCmd  = CMD_ONE_BY_ONE;
	pscmPacket->sData[0].bApp  = TRUE;
	pscmPacket->sData[0].usPN  = 0;



	pscmPacket->sData[0].uApp.sOneByOne.ucNum = 1;
	pscmPacket->sData[0].uApp.sOneByOne.sOne[0].eCmd = CMD_CFG_TML_UP;
	pscmPacket->sData[0].uApp.sOneByOne.sOne[0].usPn = 0;
	pscmPacket->sData[0].uApp.sOneByOne.sOne[0].bOk  = TRUE;

	pscmPacket->sData[0].uApp.sOneByOne.sOne[1].eCmd = CMD_CFG_TML_POWER;
	pscmPacket->sData[0].uApp.sOneByOne.sOne[1].usPn = 0;
	pscmPacket->sData[0].uApp.sOneByOne.sOne[1].bOk  = TRUE;
...
eMtErr test_pack_afn01f1_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_1_F1_HARD_INIT;
...
eMtErr test_pack_afn01f2_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_1_F2_DATA_INIT;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn01f3_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_1_F3_FACTORY_RESET;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn01f4_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_1_F4_PARA_INIT;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn04f3()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_4_F3_MST_IP_PORT;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;

    pscmPacket->sData[0].uApp.sTmIpPort.ulMainVersion = 0x01;
    pscmPacket->sData[0].uApp.sTmIpPort.ulMainIP = 0x11223344;
    pscmPacket->sData[0].uApp.sTmIpPort.usMainPort = 0x0010;
...
eMtErr test_pack_afn04f13()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->sData[0].uApp.sTmTerminalCfg.Nature = 0x00;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.Flag = 0x00;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.Port = 48;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.PortType = 0x5f;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.address[0] = 0x11;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.address[1] = 0x22;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.address[2] = 0x33;
    pscmPacket->sData[0].uApp.sTmTerminalCfg.address[3] = 0x44;
...
eMtErr test_pack_afn04f15_ms()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    // 数据1
    pscmPacket->sData[0].eCmd  = CMD_AFN_4_F15_HAVE_DIFF_EVENT;
    pscmPacket->sData[0].bApp  = TRUE;
    pscmPacket->sData[0].usPN  = 1;


    pscmPacket->sData[0].uApp.stmCtrlWaycfg.BeginTime.ucYY = 13;
    pscmPacket->sData[0].uApp.stmCtrlWaycfg.BeginTime.ucMM = 8;
    pscmPacket->sData[0].uApp.stmCtrlWaycfg.BeginTime.ucDD = 23;

	pscmPacket->sData[0].uApp.stmCtrlWaycfg.LastTime = 13;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.WayFlag = 8;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.ucM= 2;

	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[0].sBegin.ucHH = 2;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[0].sBegin.ucmm = 3;

	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[0].sEnd.ucHH = 4;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[0].sEnd.ucmm = 5;

	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[1].sBegin.ucHH = 2;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[1].sBegin.ucmm = 3;

	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[1].sEnd.ucHH = 4;
	pscmPacket->sData[0].uApp.stmCtrlWaycfg.sTime[1].sEnd.ucmm = 5;
...
eMtErr test_pack_afn0af1_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_A_F1_TML_UP_CFG;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn0af3_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_A_F3_MST_IP_PORT;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn0af13_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_A_F13_LED_UP_CFG;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn0af15_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
    ...
    pscmPacket->usDataNum = 1;
    pscmPacket->sData[0].eCmd  = CMD_AFN_A_F15_HAVE_DIFF_EVENT;
    pscmPacket->sData[0].bApp  = FALSE;
    pscmPacket->sData[0].usPN  = 0;
...
eMtErr test_pack_afn11hf4_m2s()
{
   ...
   smtPack *pscmPacket = (smtPack*)g_ucPackMem;
	...
	pscmPacket->usDataNum = 1;
	pscmPacket->sData[0].eCmd  = CMD_AFN_11_F4;
	pscmPacket->sData[0].bApp  = TRUE;
	pscmPacket->sData[0].usPN  = 1;



	pscmPacket->sData[0].uApp.std_11f4.ucDataUnit = 0x1105;
	pscmPacket->sData[0].uApp.std_11f4.ucTaskType = 0x06;
...
{   
  //  {CMD_AFN_0_F1_ALL_OK,          test_pack_0001_m2s},
    ...
    {CMD_AFN_1_F2_DATA_INIT,	   test_pack_afn01f2_m2s},
    {CMD_AFN_1_F3_FACTORY_RESET,   test_pack_afn01f3_m2s},
    {CMD_AFN_1_F4_PARA_INIT,	   test_pack_afn01f4_m2s},
    {CMD_AFN_2_F1_LOG_IN,          test_pack_afn02f1},
    {CMD_AFN_4_F1_TML_UP_CFG,      test_pack_afn04f1},
    {CMD_AFN_4_F3_MST_IP_PORT,     test_pack_afn04f3},
    {CMD_AFN_4_F10_TML_POWER_CFG,  test_pack_afn04f10},
	 {CMD_AFN_4_F13_TML_SIMULA_CFG, test_pack_afn04f13},
	 {CMD_AFN_4_F15_HAVE_DIFF_EVENT, test_pack_afn04f15_ms},
    ...
    {CMD_AFN_9_F8_SUPPORT_EVNT_CFG,   test_pack_afn09f8_m2s},
	 {CMD_AFN_A_F1_TML_UP_CFG,			  test_pack_afn0af1_m2s},
	 {CMD_AFN_A_F3_MST_IP_PORT,		  test_pack_afn0af3_m2s},
	 {CMD_AFN_A_F13_LED_UP_CFG,	  test_pack_afn0af13_m2s},
	 {CMD_AFN_A_F15_HAVE_DIFF_EVENT,	  test_pack_afn0af15_m2s},
...
sTestPack  g_test_pack[] = 
{
    ...
    {CMD_AFN_0_F1_ALL_OK,          test_pack_0001_s2m},
	 {CMD_AFN_0_F2_ALL_DENY,		  test_pack_0002_s2m},
    {CMD_AFN_0_F3_ONE_BY_ONE,      test_pack_afn0f3_s2m},
    {CMD_AFN_2_F1_LOG_IN,          test_pack_afn02f1},
	 {CMD_AFN_2_F2_LOG_OUT,          test_pack_afn02f2},
	 {CMD_AFN_2_F3_HEART_BEAT,          test_pack_afn02f3},
    {CMD_AFN_4_F1_TML_UP_CFG,      test_pack_afn04f1},
   ...
   // {CMD_AFN_C_F2_TML_CLOCK,          test_pack_afn0cf02_s2m},   // 被动应答
    ...
    {CMD_AFN_C_F25_POWER_RATE_CUR, test_pack_afn0cf25_S2M},
	 ...
	 {CMD_AFN_11_F4,       	      test_pack_afn11hf4_s2m},
...
void show_app_sub_data(eMtDir eDir,eMtCmd emtCmd, uMtApp *puAppData)
{
    ...
    switch(emtCmd)
    {
        ...
        case CMD_AFN_A_F66_CFG_AUTO_2:
        {
            ...
            printf("eUnit    = %s\n", pStr);
            printf("ucPeriod = %d\n", pData->ucPeriod);
            printf("sTime    = %02d年%02d月%02d日 %02d:%02d:%02d\n", 
                    pData->sTime.ucYear,
                    pData->sTime.ucMonth,
                    pData->sTime.ucDay, 
                    // pData->sTime.ucWeek,
...
void unpack_analyse(int nstart, int argc, char *argv[])
{
    ...
    show_sub_name(" L1:"); 
    printf("[%02X %02X]", sUnpackCommon.sfComHead.L1, sUnpackCommon.sfComHead.L2);
    ...
    // L2   
    show_sub_name("\t\t L2:");
    printf("[%02X %02X]\t", sUnpackCommon.sfComHead.L1_2 , sUnpackCommon.sfComHead.L2_2);
